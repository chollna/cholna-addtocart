    ...
    <tfoot>
        ...
        <tr>
            <td colspan="5" style="text-align:right;">
                ...
                <button class="btn btn-success" type="button" ><i class="fa fa-money"></i> <a style="color: white;" href="{{ route('order1') }}">Check out</a></button>
...
<!------->
            ...
            <a class="btn btn-primary" href="{{ route('clearcart') }}">clear session</a>
            </td>
